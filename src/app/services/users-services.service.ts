...
export class UsersServicesService {
  ...
  constructor(private httpClient: HttpClient) {
    ...
    this.baseUrl = 'http://3c1d-85-62-2-98.ngrok.io/api/users/';
  //   this.arrUsers = [
  //     {
  //       id: 1,
  //       nombre: "Jesus",
  ...
  registerAthlete(pForm: any): Promise<any> {
    ...
    return this.httpClient.post<any>(this.baseUrl + 'register/athlete', pForm, httpOptions).toPromise();
  }
  ...
  login(pForm: any): Promise<any> {
    ...
    return this.httpClient.post<any>(this.baseUrl + 'login', pForm, httpOptions).toPromise();
  }
